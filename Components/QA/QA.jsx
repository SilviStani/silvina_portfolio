          ...
          <div className="projects-grid" data-testid="qa-projects-grid">
            ...
            <div className="project-card" data-testid="qa-project-card">
              <div className="project-content" data-testid="qa-project-content">
                <h3 className="project-title" data-testid="qa-project-title">
                  E2E TESTING
                </h3>
            ...
            <a
              href="/assets/Brief_Guide_E2E_Testing_Key_Takeaways.pptx"
              download
              data-testid="download-brief-link"
            >
              <p className="download_button" data-testid="download-button">
                <img src="/assets/download.png" alt="Download Icon" style={{ height: '20px' }} />{' '}
                'Brief Guide E2E Testing'
              </p>
            </a>
          </div>
        </div>
