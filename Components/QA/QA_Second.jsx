          ...
          <div className="projects-grid" data-testid="qa-second-projects-grid">
            ...
            <div className="project-card" data-testid="qa-second-project-card">
              <div className="project-content" data-testid="qa-second-project-content">
                <h3 className="project-title" data-testid="qa-second-project-title">
                  BEST PRACTICES
                </h3>
                <div className="carousel" data-testid="qa-second-carousel">
                  <button
                    ...
                    data-testid="carousel-second-prev-btn"
                  >
                    {'<'}
                  </button>
                  <img
                  ...
                  <button
                    ...
                    data-testid="carousel-second-next-btn"
                  >
                    {'>'}
                  </button>
                </div>
            ...
            <a
              href="/assets/E2E_Testing_Best_Practices.pptx"
              download
              className="download_button"
              data-testid="download-best-practices-link"
            >
              <p data-testid="download-best-practices-button">
                <img src="/assets/download.png" alt="Download Icon" style={{ height: '20px' }} />{' '}
                'Steps & Best Practices: E2E Testing'
              </p>
            </a>
          </div>
        </div>
