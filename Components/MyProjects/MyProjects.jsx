      ...
      <div className="projectsContainer" data-testid="my-projects-container">
        ...
        <div className="projectsHeader" data-testid="my-projects-header">
          ...
          <p className="projectsHeadDescription" data-testid="my-projects-head-description">
            A selection of my most recent and relevant work, showcasing my expertise
            in full-stack development, QA automation, and modern web technologies.
          </p>
        ...
        <div className="featuredProjectsGrid" data-testid="featured-projects-grid">
          {featuredProjects.map((project) => (
            ...
            >
              ...
              >
                {/* Card Image */}
                <div className="projectCardImage" data-testid={`featured-project-image-${project.id}`}>
                  <img
                    src={project.image}
                    alt={project.title}
                    data-testid={`featured-project-img-${project.id}`}
                  />
                  <div className="imageOverlay" data-testid={`featured-project-overlay-${project.id}`}>
                    <p data-testid={`featured-project-overlay-text-${project.id}`}>
                      View Project
                    </p>
                  </div>
                </div>
                ...
                <div className="projectCardContent" data-testid={`featured-project-content-${project.id}`}>
                  ...
                  <h3 className="projectCardTitle" data-testid={`featured-project-title-${project.id}`}>
                    {project.title}
                  </h3>
                </div>
              </article>
