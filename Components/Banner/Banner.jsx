  ...
  return (
    <section className="Component" data-testid="banner-section">
      <ul className="skillsList" data-testid="skills-list">
        {skills.map((skill) => (
          <li key={skill.id} className="skillItem" data-testid={`banner-skill-${skill.id}`} id={`skill-${skill.id}`}>
            <span className="icon" data-testid={`banner-skill-icon-${skill.id}`}>★</span>
            <span className="name" data-testid={`banner-skill-name-${skill.id}`}>{skill.name}</span>
            <span className="description" data-testid={`banner-skill-desc-${skill.id}`}>{skill.description}</span>
          </li>
        ))}
      </ul>
    </section>
